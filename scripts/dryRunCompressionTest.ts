...
const BLACK = stub({
  ...
  ai_dna: {"tone":"Deep black","status":"approved","version":1,"undertone":"neutral-cool","brightness":"minimum","saturation":"zero","description":"Deep black tone, near-zero reflectivity, undertone neutral-cool. Absorbs light completely, matte finish with minimal sheen.","componentRules":[],"referenceInstruction":null},
  render_recipe: {"status":"configured","version":1,"rendering_approach":"Render as deep black with cool undertone. Directional lighting to reveal grain. Hex: #1A1A1A."},
})
...
const PATCH_POCKET = stub({
  ...
  dna_color_id: null,
  ai_dna: {"style":"patch","status":"approved","version":4,"metadata":{"approvedAt":"2026-08-05T02:28:08.484Z","approvedBy":null,"generatedAt":"2026-08-05T02:28:08.483Z","sourceImage":"https://vdgkbzpdgmlzyxaiznka.supabase.co/storage/v1/object/public/master-data-photos/saku/2de82004-99a5-4e1e-a5e0-787c9cbac3a5.jpg"},"componentRules":["Preserve the pocket outline exactly as shown in the Hero Image.","Preserve the visible opening shape and bottom contour.","Do not modify the inherited Standard Pocket dimensions."],"placement":{"anchor":"upper_body_front_panel","location":"chest_left_or_side","offset_from_armhole":"2.0cm"},"referenceInstruction":"Use the Hero Image only as the structural reference for this pocket.\n\nFollow only the visible pocket shape, opening, edge profile, seam flow, symmetry, and overall proportion.\n\nIgnore fabric texture, fabric color, lighting, shadow, background, depth of field, and camera characteristics.\n\nDo not infer any geometry, construction, or detail that is not visible in the Hero Image."},
  render_recipe: {"status":"configured","version":1,"target_model":"gpt-image-1","component_scope":"pocket_outline_topstitch_shadow_only"},
})
