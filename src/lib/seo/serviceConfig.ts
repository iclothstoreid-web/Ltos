...
const LOCATION_FAQ_ITEM_EN: ServiceFaqItem = {
  ...
  answer:
    "Our workshop and showroom are at Jl. Gamelan No.10, Buah Batu, Bandung — Local Tailor's only physical location, where consultation, measurement, and production all take place. Full location details and the areas we serve are on the Bandung location page.",
}
...
const LOCATION_FAQ_ITEM_AR: ServiceFaqItem = {
  ...
  answer:
    'تقع ورشتنا وصالة العرض في Jl. Gamelan No.10, Buah Batu, باندونغ — وهي الموقع الفعلي الوحيد لـ Local Tailor، حيث تجري الاستشارة والقياس والإنتاج. التفاصيل الكاملة للموقع والمناطق التي نخدمها متوفرة في صفحة موقع باندونغ.',
}
