...
const SERVICE_TERM_KEYWORDS: KeywordEntry[] = [
  { primaryKeyword: 'tailor terbaik indonesia', secondaryKeyword: 'rekomendasi tailor terbaik', intent: 'commercial', targetPage: '/bespoke-tailor-indonesia', cluster: 'bandung', commercialScore: 8, authorityScore: 6 },
  ...
  { primaryKeyword: 'jasa jahit custom online', secondaryKeyword: 'jasa jahit custom tanpa datang', intent: 'commercial', targetPage: '/custom-thobe-indonesia', cluster: 'design-studio', commercialScore: 8, authorityScore: 6 },
  ...
  { primaryKeyword: 'jahit custom online', secondaryKeyword: 'pesan jahit custom online', intent: 'commercial', targetPage: '/custom-thobe-indonesia', cluster: 'design-studio', commercialScore: 8, authorityScore: 6 },
  { primaryKeyword: 'custom made thobe', secondaryKeyword: 'custom made pria muslim', intent: 'commercial', targetPage: '/custom-thobe-indonesia', cluster: 'design-studio', commercialScore: 7, authorityScore: 6 },
  ...
  { primaryKeyword: 'tailor premium indonesia', secondaryKeyword: 'tailor high end indonesia', intent: 'commercial', targetPage: '/bespoke-tailor-indonesia', cluster: 'bandung', commercialScore: 8, authorityScore: 6 },
  ...
  { primaryKeyword: 'pesan thobe online', secondaryKeyword: 'cara pesan thobe custom online', intent: 'transactional', targetPage: '/custom-thobe-indonesia', cluster: 'design-studio', commercialScore: 9, authorityScore: 5 },
  ...
  { primaryKeyword: 'tailor online terpercaya', secondaryKeyword: 'jasa tailor online indonesia', intent: 'commercial', targetPage: '/custom-thobe-indonesia', cluster: 'design-studio', commercialScore: 8, authorityScore: 5 },
...
const LUXURY_KEYWORDS: KeywordEntry[] = [
  ...
  { primaryKeyword: 'tailor luxury indonesia', secondaryKeyword: 'tailor mewah indonesia', intent: 'commercial', targetPage: '/bespoke-tailor-indonesia', cluster: 'bandung', commercialScore: 8, authorityScore: 6 },
  ...
  { primaryKeyword: 'thobe kelas atas indonesia', secondaryKeyword: 'thobe premium indonesia', intent: 'commercial', targetPage: '/bespoke-tailor-indonesia', cluster: 'bandung', commercialScore: 7, authorityScore: 5 },
...
const TAILOR_PENJAHIT_NATIONAL_KEYWORDS: KeywordEntry[] = [
  { primaryKeyword: 'tailor pria indonesia', secondaryKeyword: 'tailor pria terbaik indonesia', intent: 'commercial', targetPage: '/bespoke-tailor-indonesia', cluster: 'bandung', commercialScore: 7, authorityScore: 5 },
  { primaryKeyword: 'penjahit pria indonesia', secondaryKeyword: 'penjahit pria terpercaya indonesia', intent: 'commercial', targetPage: '/bespoke-tailor-indonesia', cluster: 'bandung', commercialScore: 7, authorityScore: 5 },
  ...
  { primaryKeyword: 'tailor muslim indonesia', secondaryKeyword: 'tailor khusus busana muslim pria', intent: 'commercial', targetPage: '/bespoke-tailor-indonesia', cluster: 'bandung', commercialScore: 7, authorityScore: 5 },
  { primaryKeyword: 'jasa jahit custom indonesia', secondaryKeyword: 'jasa jahit custom pria muslim', intent: 'commercial', targetPage: '/custom-thobe-indonesia', cluster: 'bandung', commercialScore: 7, authorityScore: 5 },
  { primaryKeyword: 'penjahit premium indonesia', secondaryKeyword: 'penjahit kelas premium indonesia', intent: 'commercial', targetPage: '/bespoke-tailor-indonesia', cluster: 'bandung', commercialScore: 7, authorityScore: 5 },
  { primaryKeyword: 'tailor pria muslim indonesia', secondaryKeyword: 'tailor busana muslim pria indonesia', intent: 'commercial', targetPage: '/bespoke-tailor-indonesia', cluster: 'bandung', commercialScore: 7, authorityScore: 5 },
  { primaryKeyword: 'penjahit muslim indonesia', secondaryKeyword: 'penjahit khusus muslim pria', intent: 'commercial', targetPage: '/bespoke-tailor-indonesia', cluster: 'bandung', commercialScore: 6, authorityScore: 4 },
  ...
  { primaryKeyword: 'penjahit online indonesia', secondaryKeyword: 'jasa penjahit online terpercaya', intent: 'commercial', targetPage: '/custom-thobe-indonesia', cluster: 'design-studio', commercialScore: 7, authorityScore: 5 },
  { primaryKeyword: 'tailor jarak jauh indonesia', secondaryKeyword: 'tailor tanpa perlu datang', intent: 'commercial', targetPage: '/custom-thobe-indonesia', cluster: 'design-studio', commercialScore: 7, authorityScore: 5 },
  ...
  { primaryKeyword: 'penjahit thobe terpercaya indonesia', secondaryKeyword: 'penjahit thobe rekomendasi indonesia', intent: 'commercial', targetPage: '/bespoke-tailor-indonesia', cluster: 'bandung', commercialScore: 7, authorityScore: 5 },
