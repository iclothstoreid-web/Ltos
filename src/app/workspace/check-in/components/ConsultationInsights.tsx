...
export function ConsultationInsights() {
  ...
  return (
    <section className="w-[25%] border-l-[0.5px] border-[#c4c7c7] bg-white/30 p-8 flex flex-col gap-6 overflow-y-auto">
      <h3 className="font-sans text-xs uppercase tracking-widest text-[#444748] mb-4">
