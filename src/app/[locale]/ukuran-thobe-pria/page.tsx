...
import { ukuranThobePriaContent } from '@/lib/content/articles'
...
const content = ukuranThobePriaContent
const SIZE_TABLE_HEADING = 'Tabel Perkiraan Ukuran Thobe Pria'
...
export default function UkuranThobePriaPage() {
      ...
      <article>
        ...
        {content.sections.map((section, index) => (
          <div key={section.heading}>
            ...
            {section.heading === SIZE_TABLE_HEADING && content.sizeChart && <SizeChartTable rows={content.sizeChart} />}
          </div>
        ))}
