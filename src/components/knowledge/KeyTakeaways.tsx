interface KeyTakeawaysProps {
  items: string[]
  headingId: string
  // Sprint W6-10 — override lets this same component double as the
  // "Decision Framework" citation block (bullet criteria) without a
  // near-duplicate component; default keeps every W6-8 call site unchanged.
  heading?: string
}
...
export function KeyTakeaways({ items, headingId, heading = 'Poin Penting' }: KeyTakeawaysProps) {
