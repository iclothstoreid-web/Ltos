...
//
// Renamed "Status SLA" (Milestone 4): this section is deadline/SLA-window
// classification only. Business Priority (Normal/High/Critical) is a
// separate signal with its own section (BusinessPriorityBoard) -- the
// brief is explicit that these must not be mixed into one "Priority" label.
  ...
  return (
    <section>
      <div className="flex items-end justify-between gap-4 mb-3">
        <h2 className="text-label text-secondary uppercase tracking-[0.24em]">Status SLA</h2>
