...
const COLORS = [
  { name: 'Ivory', hex: '#F4EEE4' },
  { name: 'Charcoal', hex: '#1C1A18' },
  { name: 'Bronze', hex: '#8A6B3D' },
...
export function ConfiguratorPreview() {
  ...
  return (
    <section id="configurator" aria-labelledby="configurator-heading" className="bg-luxury-black px-6 py-24 md:px-10">
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-2 lg:items-center">
        ...
        <Reveal delay={0.1}>
          ...
          <p className="mt-4 max-w-md font-luxury-sans text-sm text-luxury-ivory/60">{configuratorCopy.body}</p>

          <div className="mt-8">
            <p className="font-luxury-sans text-xs uppercase tracking-[0.14em] text-luxury-ivory/50">{configuratorCopy.fabricLabel}</p>
          ...
          <div className="mt-6">
            <p className="font-luxury-sans text-xs uppercase tracking-[0.14em] text-luxury-ivory/50">{configuratorCopy.colorLabel}</p>
          ...
          <div className="mt-8 grid grid-cols-2 gap-6 border-t border-luxury-ivory/10 pt-6">
            <div>
              <p className="font-luxury-sans text-xs uppercase tracking-[0.14em] text-luxury-ivory/50">{configuratorCopy.priceLabel}</p>
              <p className="mt-1 font-fraunces text-xl text-luxury-ivory">{fabric.name}</p>
              <p className="font-luxury-sans text-xs text-luxury-ivory/50">{fabric.origin}</p>
            </div>
            <div>
              <p className="font-luxury-sans text-xs uppercase tracking-[0.14em] text-luxury-ivory/50">{configuratorCopy.timeLabel}</p>
              <p className="mt-1 font-fraunces text-xl text-luxury-ivory">2–3 weeks</p>
              <p className="font-luxury-sans text-xs text-luxury-ivory/50">{fabric.trait}</p>
            </div>
          </div>
