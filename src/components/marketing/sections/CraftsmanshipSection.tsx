import { craftsmanshipDetailsCopy } from '@/lib/marketing/copy'
    ...
    <section id="craftsmanship-details" aria-labelledby="craftsmanship-details-heading" className="bg-luxury-navy px-6 py-24 md:px-10">
      <div className="mx-auto max-w-6xl">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="font-luxury-sans text-xs uppercase tracking-[0.2em] text-luxury-gold">{craftsmanshipDetailsCopy.eyebrow}</p>
          <h2 id="craftsmanship-details-heading" className="mt-3 font-fraunces text-3xl text-luxury-ivory md:text-4xl">
            {craftsmanshipDetailsCopy.heading}
          </h2>
          <p className="mt-4 font-luxury-sans text-sm text-luxury-taupe">{craftsmanshipDetailsCopy.subheadline}</p>
        </Reveal>

        <ul className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {craftsmanshipDetailsCopy.cards.map((card, i) => (
        ...
        <Reveal delay={0.2} className="mt-14 text-center">
          <blockquote className="mx-auto max-w-xl border-l-2 border-luxury-gold/40 pl-5 text-left">
            <p className="font-fraunces text-xl italic leading-snug text-luxury-ivory md:text-2xl">&ldquo;{craftsmanshipDetailsCopy.statement}&rdquo;</p>
          </blockquote>

          <MagneticButton href={ctaHref} variant="primary" className="mt-10">
            {craftsmanshipDetailsCopy.cta}
          </MagneticButton>
        </Reveal>
      </div>
    </section>
