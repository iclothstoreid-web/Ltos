    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed inset-x-0 bottom-0 z-40 border-t border-luxury-gold/20 bg-luxury-black/95 p-4 pb-[calc(1rem+env(safe-area-inset-bottom))] backdrop-blur-md md:hidden"
        >
          <a
            href="/#configurator"
