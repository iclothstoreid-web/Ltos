...
const CARDS: HubCard[] = [
  {
    label: 'Design Master',
    description: 'Model, Kerah, Manset, Bahan, Warna, Aksesori, Bordir, Handmade Zig-Zag — termasuk harga.',
    href: '/owner/master-data',
    icon: Sparkles,
  },
  {
    label: 'Material Master Inventory',
  ...
  {
    label: 'Operator',
    description: 'CRUD Operator, status Aktif/Libur/Cuti/Nonaktif.',
