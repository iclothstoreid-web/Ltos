  ...
  return (
    <div className="fixed inset-0 z-[80] bg-black/50 flex items-center justify-center p-6">
      <div className="bg-white max-w-sm w-full p-6 rounded-sm">
        <p className="font-hanken text-lg text-on-surface mb-2">Yakin bade kaluar ti dieu?</p>
        <p className="font-hanken text-sm text-secondary mb-6">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 py-3 font-hanken text-sm font-semibold uppercase tracking-widest
                       border border-on-surface text-on-surface hover:bg-on-surface/5 transition-colors"
          >
            Teu Wios
          </button>
          <button
            ...
            className="flex-1 py-3 font-hanken text-sm font-semibold uppercase tracking-widest
                       bg-on-surface text-white hover:bg-amber-mid transition-colors"
          >
            Keluar
          </button>
        </div>
