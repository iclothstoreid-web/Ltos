    ...
    <section className="bg-white/70 backdrop-blur-sm border-[0.5px] border-[#c4c7c7]/40 shadow-sm p-4">
      ...
      <div className="space-y-3 mb-6">
        <div className="flex justify-between font-sans text-sm">
          <span className="text-[#444748]">Garment</span>
          <span className="text-[#151c27]">Belum dihitung</span>
        </div>
        <div className="flex justify-between font-sans text-sm">
          <span className="text-[#444748]">Accessories &amp; Customization</span>
          <span className="text-[#151c27]">Belum dihitung</span>
        </div>
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-2 text-[#ba1a1a]">
          ...
          <span className="font-sans text-xs uppercase">Status: Not Collected</span>
        </div>
